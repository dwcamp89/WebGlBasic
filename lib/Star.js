  ...
  define(['GLContext', 'ModelViewMatrix', 'PerspectiveMatrix', 'glMatrix-0.9.5.min', 'ShaderProgramFactory'], function(glContext, mvMatrix, pMatrix, glMatrix, ShaderProgramFactory) {
    ...
    Star = (function() {
      ...
      Star.prototype.render = function() {
        ...
        mat4.rotate(mvMatrix, Math.toRadians(this.tilt), [1.0, 0.0, 0.0]);
        mat4.rotate(mvMatrix, Math.toRadians(this.angle), [0.0, 1.0, 0.0]);
        mat4.translate(mvMatrix, [this.distance, 0.0, 0.0]);
        mat4.rotate(mvMatrix, Math.toRadians(this.angle * -1.0), [0.0, 1.0, 0.0]);
        mat4.rotate(mvMatrix, Math.toRadians(this.tilt * -1.0), [1.0, 0.0, 0.0]);
        if (twinkle) {
          gl.uniform3f(shaderProgram.colorUniform, this.twinkleR, this.twinkleG, this.twinkleB);
          this.drawStar();
        }
        mat4.rotate(mvMatrix, Math.toRadians(this.spin), [0.0, 0.0, 1.0]);
