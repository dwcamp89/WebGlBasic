...
(function() {
  ...
  define(['GLContext', 'ModelViewMatrix', 'PerspectiveMatrix', 'glMatrix-0.9.5.min', 'ShaderProgramFactory', 'LightFactory'], function(glContext, mvMatrix, pMatrix, glMatrix, ShaderProgramFactory, LightFactory) {
    ...
    Sphere = (function() {
      var handleLoadedTexture, initializeShader;
      ...
      function Sphere() {
        ...
        this.pointLight = LightFactory.getInstance('PointLight');
        this.pointLight.setX(0);
        this.pointLight.setZ(-20);
      ...
      Sphere.prototype.setLightingUniforms = function() {
        ...
        gl.uniform3f(this.shaderProgram.pointLightingLocationUniform, this.pointLight.getX(), this.pointLight.getY(), this.pointLight.getZ());
        return gl.uniform3f(this.shaderProgram.pointLightingColorUniform, this.pointLight.getRed(), this.pointLight.getGreen(), this.pointLight.getBlue());
      };

      Sphere.prototype.setPosition = function() {
        mat4.translate(mvMatrix.getMatrix(), [this.x, this.y, this.z]);
        return mat4.multiply(mvMatrix.getMatrix(), this.rotationMatrix);
      };
