...
(function() {
  require(['glMatrix-0.9.5.min', 'webgl-utils', 'WebGlConstants', 'shader'], function(glMatrix, webGlUtils, webGlConstants, shader) {
    var config, drawScene, fragmentShader, getShader, gl, initBuffers, initPrograms, initWebGL, mvMatrix, pMatrix, setMatrixUniforms, shaderProgram, squareVertexPositionBuffer, start, triangleVertexPositionBuffer, vertexShader;
    mvMatrix = null;
    pMatrix = null;
